...
val appModule = module {
    includes(databaseModule, memoryModule, agentModule, settingModule, profileModule, taskStateModule, invariantModule)
    single {
    ...
    single(named("invariantPrefs")) {
        get<Context>().getSharedPreferences("invariant_prefs", Context.MODE_PRIVATE)
    }
